...
pleaseFix funName = error (funName ++ ": Please fix me.")
...
nandify (F)         =  (F)
nandify (T)         =  (T)
nandify (Not p)     =  (nandify p :#: nandify p)
nandify (p :|: q)   =  (nandify p :#: nandify p) :#: (nandify q :#: nandify q)
nandify (p :&: q)   =  (nandify p :#: nandify q) :#: (nandify p :#: nandify q)
nandify (p :->: q)  =  (nandify p) :#: (nandify p :#: nandify q)
nandify (p :<->: q) =   nandify ((p :->: q) :&: (q :->: p)) -- a gift
nandify (p :#: q)   =  (nandify ( Not (p :&: q)))
